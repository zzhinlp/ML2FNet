...
class UnetPlusPlus(nn.Module):
    def __init__(self, num_classes, deep_supervision=False):
        ...
        self.liner = nn.Linear(320, 256)


    def forward(self, x):#[4, 3, 48, 48]
        x_0_0 = self.stage_0(x)#[4, 64, 48, 48]
        x_1_0 = self.stage_1(self.pool(x_0_0)) # [4, 128, 24, 24]
        x_2_0 = self.stage_2(self.pool(x_1_0)) # [4, 256, 12, 12]
        x_3_0 = self.stage_3(self.pool(x_2_0)) # [4, 512, 6, 6]
        x_4_0 = self.stage_4(self.pool(x_3_0)) # [4, 1024, 3, 3]

        x_0_1 = torch.cat([self.upsample_0_1(x_1_0), x_0_0], 1) # [4, 128, 48, 48]
        x_0_1 = self.CONV0_1(x_0_1) # [4, 64, 48, 48]

        x_1_1 = torch.cat([self.upsample_1_1(x_2_0), x_1_0], 1) # [4, 256, 24, 24]
        x_1_1 = self.CONV1_1(x_1_1) # [4, 256, 24, 24]

        x_2_1 = torch.cat([self.upsample_2_1(x_3_0), x_2_0], 1) # [4, 512, 12, 12]
        x_2_1 = self.CONV2_1(x_2_1) # [4, 256, 12, 12]

        x_3_1 = torch.cat([self.upsample_3_1(x_4_0), x_3_0], 1) # [4, 1024, 6, 6]
        x_3_1 = self.CONV3_1(x_3_1) # [4, 512, 6, 6]

        x_2_2 = torch.cat([self.upsample_2_2(x_3_1), x_2_0, x_2_1], 1) # [4, 768, 12, 12]
        x_2_2 = self.CONV2_2(x_2_2)#[4, 256, 12, 12]

        x_1_2 = torch.cat([self.upsample_1_2(x_2_1), x_1_0, x_1_1], 1) # [4, 384, 24, 24]
        x_1_2 = self.CONV1_2(x_1_2) # [4, 128, 24, 24]

        x_1_3 = torch.cat([self.upsample_1_3(x_2_2), x_1_0, x_1_1, x_1_2], 1) # [4, 512, 24, 24]
        x_1_3 = self.CONV1_3(x_1_3) # [4, 128, 24, 24]

        x_0_2 = torch.cat([self.upsample_0_2(x_1_1), x_0_0, x_0_1], 1) # [4, 192, 48, 48]
        x_0_2 = self.CONV0_2(x_0_2) # [4, 64, 48, 48]

        x_0_3 = torch.cat([self.upsample_0_3(x_1_2), x_0_0, x_0_1, x_0_2], 1) # [4, 256, 48, 48]
        x_0_3 = self.CONV0_3(x_0_3)#[4, 64, 48, 48]
        # return x_0_3.permute(0, 2, 3, 1)
        #
        x_0_4 = torch.cat([self.upsample_0_4(x_1_3), x_0_0, x_0_1, x_0_2, x_0_3], 1)#[4, 320, 48, 48]
        # return x_0_4.permute(0, 2, 3, 1)
        # x_0_4=self.liner(x_0_4.permute(0, 2, 3, 1))
        x_0_4 = self.CONV0_4(x_0_4)#[4, 64, 48, 48]
        return x_0_4.permute(0, 2, 3, 1)
        ...
        # else:
        #
        #     return self.final_super_0_4(x_0_4).permute(0, 2, 3, 1).contiguous()
...
if __name__ == "__main__":
    ...
    inputs = torch.randn((4, 768, 48, 48)).to(device)
    model = UnetPlusPlus(num_classes=256, deep_supervision=deep_supervision).to(device)
